...
export default function NewCollection({ online, offline }) {
    const options = {
        dots: false,
        infinite: true,
        speed: 500,
    ...
    return (
        <>
            ...
            <div className="new-collection-area">
            ...
            <div className="featured-product-area section-padding">
                <div className="container">
                    <div className="row">
                        <div className="section-title">
                            <h2>Featured Products</h2>
                        </div>
                        <Slider {...options} className="featured-product-list indicator-style">
                            {
                                offline.map((e, i) =>
